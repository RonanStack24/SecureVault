...
<body class="bg-dark-bg bg-dots flex flex-col justify-between antialiased selection:bg-primary/20 selection:text-primary">
    ...
    <main class="relative z-10 flex-1 flex flex-col items-center justify-center px-4 py-6 sm:py-10">
        <div class="w-full max-w-[440px] animate-card">
            ...
            <div class="mt-5 p-4 rounded-2xl bg-dark-card/60 border border-dark-border/80 backdrop-blur-sm text-left">
                <h3 class="text-xs font-bold text-gray-300 uppercase tracking-wider mb-2.5 flex items-center gap-1.5">
                    <span class="text-primary font-black">✦</span> Why Choose SecureVault?
                </h3>
                <ul class="space-y-2 text-[11px] text-gray-400">
                    <li class="flex items-start gap-2">
                        <span class="text-primary font-bold text-xs mt-0.5">✔</span>
                        <span><strong>100% Zero-Knowledge:</strong> Master keys and plaintext passwords never touch our servers.</span>
                    </li>
                    <li class="flex items-start gap-2">
                        <span class="text-primary font-bold text-xs mt-0.5">✔</span>
                        <span><strong>Full Offline Access:</strong> Open the PWA and decrypt credentials without internet or Wi-Fi.</span>
                    </li>
                    <li class="flex items-start gap-2">
                        <span class="text-primary font-bold text-xs mt-0.5">✔</span>
                        <span><strong>Military-Grade Security:</strong> AES-256-GCM authenticated encryption + 100,000 PBKDF2 rounds.</span>
                    </li>
                </ul>
            </div>

...
<body class="bg-dark-bg bg-dots min-h-screen flex flex-col items-center justify-center px-4 py-8">
    ...
    <!-- Anti-Phishing Security Warning -->
    <div class="w-full max-w-sm mb-5 p-3.5 rounded-xl bg-yellow-900/20 border border-yellow-600/50 text-yellow-500 text-[11px] leading-relaxed text-center form-enter opacity-0" style="animation-delay: 0.15s; animation-fill-mode: forwards;">
        <span class="text-sm block mb-1">⚠️</span>
        <strong>Security Warning:</strong> The only official URL for this app is <code class="font-bold text-yellow-400">securevault.great-site.net</code>. Beware of phishing sites like <span class="text-red-400 line-through">securevault.live</span> that are trying to steal information.
    </div>
    ...
    <!-- Open Source Transparency & Dev credit -->
    <div class="mt-8 text-center max-w-sm form-enter opacity-0" style="animation-delay: 0.3s; animation-fill-mode: forwards;">
        <a href="https://github.com/RonanStack24/SecureVault" target="_blank" rel="noopener noreferrer" 
           class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-dark-card border border-dark-border text-gray-400 hover:text-white hover:border-gray-500 transition-all text-xs font-semibold mb-3">
        ...
        <p class="text-[11px] text-gray-500 leading-relaxed px-4">
            Don't trust closed-source vaults. Our code is <strong class="text-gray-300">100% open-source</strong> and verifiable on GitHub.
        </p>
        <p class="text-xs text-gray-700 mt-4">Developed by Ronan Antoque</p>
    </div>
